...
int deals_new(uint32_t user_id, uint64_t order_id, uint64_t id, double timestamp, 
    int type, const char *client_id, const char *market, const char *amount, const char *price);
